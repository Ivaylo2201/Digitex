...
public static class Data
{
    ...
    [
        new()
        {
            ...
            ImagePath = "processors/intel_core_i312100_tray.jpg",
            InitialPrice = 102.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 4,
            Threads = 8,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i310105_box.jpg",
            InitialPrice = 102.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 4,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i513400f_box.jpg",
            InitialPrice = 138.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 10,
            Threads = 16,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_7_5700x.jpg",
            InitialPrice = 184.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 8,
            Threads = 16,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i514600kf.jpg",
            InitialPrice = 230.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 14,
            Threads = 20,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i714700kf.jpg",
            InitialPrice = 353.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 20,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_9_7900x.png",
            InitialPrice = 359.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 12,
            Threads = 24,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_9_9950x.jpg",
            InitialPrice = 598.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 16,
            Threads = 32,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_9_9900x3d.jpg",
            InitialPrice = 640.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 12,
            Threads = 24,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_ultra_9_285k.jpg",
            InitialPrice = 640.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 24,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_3_4100_box.jpg",
            InitialPrice = 56.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 4,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_5_3600_.png",
            InitialPrice = 61.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i312100f.jpg",
            InitialPrice = 81.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 4,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_5_5600.png",
            InitialPrice = 117.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
            Threads = 12,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_5_5500gt.png",
            InitialPrice = 128.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
            Threads = 12,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_7_5700.png",
            InitialPrice = 138.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 8,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_5_5600gt.png",
            InitialPrice = 143.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
            Threads = 12,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i313100.jpg",
            InitialPrice = 153.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 4,
            Threads = 8,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_5_8400f.jpg",
            InitialPrice = 153.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i314100.png",
            InitialPrice = 163.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 4,
            Threads = 8,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_7_5700g.png",
            InitialPrice = 169.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 8,
            Threads = 16,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i512400.jpg",
            InitialPrice = 194.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
            Threads = 12,
        ...
        new()
        {
            ...
            ImagePath = "processors/amd_ryzen_5_7600_box.png",
            InitialPrice = 199.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 6,
            Threads = 12,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i514400f.png",
            InitialPrice = 199.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 10,
        ...
        new()
        {
            ...
            ImagePath = "processors/intel_core_i512600k.jpg",
            InitialPrice = 199.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Cores = 10,
    ...
    [
        ...
        new()
        {
            ...
            ImagePath = "rams/32gb_2x16gb_ddr5_6400_mts_cl32_corsair_vengeance_rgb_grey.png",
    ...
    [
        ...
        new()
        {
            ...
            ImagePath = "motherboards/gigabyte_b760_gaming_x_ddr4.png",
            InitialPrice = 138.00m,
            DiscountPercentage = GetRandomDiscountPercentage(),
            Quantity = GetRandomQuantity(),
            Socket = Socket.Lga1700,
    ...
    public static readonly List<Exchange> ExchangeRates =
    [
        new() { FromCurrency = Currencies["usd"], ToCurrency = Currencies["eur"], Rate = 0.85m }, 
        new() { FromCurrency = Currencies["usd"], ToCurrency = Currencies["gbp"], Rate = 0.75m }, 
        new() { FromCurrency = Currencies["eur"], ToCurrency = Currencies["usd"], Rate = 1.20m }, 
        new() { FromCurrency = Currencies["eur"], ToCurrency = Currencies["gbp"], Rate = 0.90m }, 
        new() { FromCurrency = Currencies["gbp"], ToCurrency = Currencies["usd"], Rate = 1.35m }, 
        new() { FromCurrency = Currencies["gbp"], ToCurrency = Currencies["eur"], Rate = 1.15m }
    ];
