...
public static class DependencyInjection
{
    extension(IServiceCollection services)
    {
        ...
        private IServiceCollection AddServices() => services
            ...
            .AddTransient<IExpressionBuilderService<Monitor>, MonitorQueryBuilderService>()
            .AddTransient<IExpressionBuilderService<Ram>, RamQueryBuilderService>()
            .AddTransient<IExpressionBuilderService<Processor>, ProcessorQueryBuilderService>()
            .AddTransient<IExpressionBuilderService<GraphicsCard>, GraphicsCardQueryBuilderService>()
            .AddTransient<IExpressionBuilderService<Ssd>, SsdQueryBuilderService>()
            .AddTransient<IExpressionBuilderService<Motherboard>, MotherboardQueryBuilderService>()
            .AddTransient<IExpressionBuilderService<PowerSupply>, PowerSupplyQueryBuilderService>()
